...
momoP0 = './momo-2022.2.0_ubuntu-18.04_armv8_jetson_xavier/momo --hw-mjpeg-decoder=false --resolution 4K --use-sdl --show-me --video-device /dev/video0 sora --signaling-url wss://sora.ikeilabsora.0am.jp/signaling --channel-id twincam-right --multistream 1 --role sendonly --video-codec-type H264 --video-bit-rate 15000'
