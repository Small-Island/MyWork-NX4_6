...
momoP0 = './momo-2021.2.3_ubuntu-18.04_armv8_jetson_xavier/momo --hw-mjpeg-decoder=false --resolution 4K --video-device /dev/video0 test --port 8081'
# momoP0 = './momo-2022.1.0_ubuntu-18.04_armv8_jetson_xavier/momo --hw-mjpeg-decoder=false --resolution 4K --video-device /dev/video0 test --port 8081'
# momoP0 = './momo-2022.1.0_ubuntu-18.04_armv8_jetson_xavier/momo --hw-mjpeg-decoder=false --resolution 4K --video-device /dev/video0 --use-sdl --show-me --serial /home/tristar/joy_segway_rosless/webrtc_momo/serial_in,9600 test --port 8081 --document-root ./momo-2022.1.0_ubuntu-18.04_armv8_jetson_xavier/html'
...
momoP1 = './momo-2022.1.0_ubuntu-18.04_armv8_jetson_xavier/momo --hw-mjpeg-decoder=false --resolution 4K --video-device /dev/video1 test --port 8082'
# momoP1 = './momo-2022.1.0_ubuntu-18.04_armv8_jetson_xavier/momo --hw-mjpeg-decoder=false --resolution 4K --video-device /dev/video1 test --port 8082 ./momo-2022.1.0_ubuntu-18.04_armv8_jetson_xavier'
# momoP1 = './momo-2022.1.0_ubuntu-18.04_armv8_jetson_xavier/momo --hw-mjpeg-decoder=false --resolution 4K --video-device /dev/video1 sora --signaling-url wss://sora.ikeilabsora.0am.jp/signaling --channel-id twincam-left --multistream 1 --role sendonly --video-codec-type H264 --video-bit-rate 15000'
